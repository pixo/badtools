...
class UiProjectCreator (QtGui.QMainWindow):
    ...
    def __init__(self, parent=None):
        ...
        self.horizontalLayout_username.setObjectName(
        ...
        self.horizontalLayout_husername.setObjectName(
        ...
        self.verticalLayout_description.setObjectName(
            "verticalLayout_description")
        ...
        self.plainTextEdit_description = QtGui.QPlainTextEdit(
            self.centralwidget)
        self.plainTextEdit_description.setObjectName(
            "plainTextEdit_description")
        self.verticalLayout_description.addWidget(
